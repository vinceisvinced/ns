...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    'bbe6e715b6ea470fa00a432c1bff651e',
  ...
  APPEARANCE_DARK_TIME: process.env.NEXT_PUBLIC_APPEARANCE_DARK_TIME || , // 夜间模式起至时间，false时关闭根据时间自动切换夜间模式

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Vince', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Monash University', // 作者简介
